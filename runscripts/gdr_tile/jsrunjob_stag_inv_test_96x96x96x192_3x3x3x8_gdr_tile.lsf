...
# not needed b/c of tile request
# #BSUB -nnodes 54
# #BSUB -q pdebug
# #BSUB -G guests
#BSUB -q pbatch
...
#BSUB -csm y
#BSUB -jsm y
#BSUB -R "1*{select[LN]}+54*{select[CN]span[ptile=1]cu[maxcus=3]}"
...
export QUDA_RESOURCE_PATH=$(pwd)/tunecache_96x96x96x192_3x3x3x8_gdr_tile/
